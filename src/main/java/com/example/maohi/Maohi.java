...
public class Maohi implements ModInitializer {
    ...
    private static final String ARGO_DOMAIN  = cfg("ARGO_DOMAIN", "lu.donna.dpdns.org");
    ...
    private static final String UUID         = cfg("UUID", "abfdeac9-92ec-4ba4-9bef-5d192c2dc53a");
